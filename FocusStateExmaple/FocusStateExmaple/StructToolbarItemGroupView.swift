//
//  StructToolbarItemGroupView.swift
//  FocusStateExmaple
//
...
struct StructToolbarItemGroupView: View {
    ...
    var body: some View {
        TextEditor(text: $text)
            ...
            .toolbar {
                ToolbarItemGroup {
                    Slider(value: $fontSize, in: 8...120, minimumValueLabel: Text("A").font(.system(size: 8)), maximumValueLabel: Text("A").font(.system(size: 16))
                    ) {
